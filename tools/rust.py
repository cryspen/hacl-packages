...
from tools.utils import argument, cli, cwd, mprint as print, subcommand, subparsers
...
@subcommand(
    [
        argument(
            "-p", "--package", help="Package the Rust bindings.", action="store_true"
        ),
        argument("-t", "--test", help="Run Rust tests.", action="store_true"),
        argument("-b", "--build", help="Build Rust.", action="store_true"),
