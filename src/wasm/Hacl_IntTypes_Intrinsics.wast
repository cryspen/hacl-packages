(module
  ...
  (type $12 (func (param i64 i64 i64 i32) (result i32 i32)))
  (type $13 (func (param i64 i64 i64 i32) (result i64)))
  (type $14 (func (param i64 i64 i64 i32) (result i32 i32)))
  ...
  (export "Hacl_IntTypes_Intrinsics_add_carry_u32" (func 9))
  (export "Hacl_IntTypes_Intrinsics_sub_borrow_u32" (func 10))
  (export "Hacl_IntTypes_Intrinsics_add_carry_u64" (func 11))
  (export "Hacl_IntTypes_Intrinsics_add_carry_u64_packed" (func 12))
  (export "Hacl_IntTypes_Intrinsics_sub_borrow_u64" (func 13))
  (export "Hacl_IntTypes_Intrinsics_sub_borrow_u64_packed" (func 14))
