...
sample_matrix_A___4size_t(uint8_t seed[34U], bool transpose, int32_t ret[4U][4U][256U])
{
  ...
  for (size_t i0 = (size_t)0U; i0 < (size_t)4U; i0++)
  {
    ...
    uint8_t uu____2[4U][34U];
    memcpy(uu____2, seeds, (size_t)4U * sizeof (uint8_t [34U]));
    int32_t sampled[4U][256U];
    sample_from_xof___4size_t(uu____2, sampled);
    core_ops_range_Range__size_t
    iter =
      core_iter_traits_collect___core__iter__traits__collect__IntoIterator_for_I___into_iter((
          (core_ops_range_Range__size_t){ .start = (size_t)0U, .end = (size_t)4U }
    ...
    i++)
  {
    ...
    while (true)
    {
      ...
      else
      {
        ...
        add_to_ring_element___4size_t(result[i0], &product, uu____1);
        memcpy(result[i0], uu____1, (size_t)256U * sizeof (int32_t));
      }
    }
    core_ops_range_Range__size_t
    iter0 =
    ...
    while (true)
    {
      ...
      else
      {
        size_t j = uu____2.f0;
        int32_t
        coefficient_normal_form = libcrux_kyber_arithmetic_to_standard_domain(result[i0][j]);
        int32_t
        uu____3 =
          libcrux_kyber_arithmetic_barrett_reduce(coefficient_normal_form + error_as_ntt[i0][j]);
        result[i0][j] = uu____3;
      }
    }
  }
  ...
  for (size_t i = (size_t)0U; i < (size_t)4U; i++)
  {
    ...
    while (true)
    {
      ...
      else
      {
        size_t j = uu____5.f0;
        uint16_t
        uu____6 = libcrux_kyber_arithmetic_to_unsigned_representative(secret_as_ntt[i0][j]);
        secret_as_ntt[i0][j] = (int32_t)uu____6;
        uint16_t uu____7 = libcrux_kyber_arithmetic_to_unsigned_representative(t_as_ntt[i0][j]);
        t_as_ntt[i0][j] = (int32_t)uu____7;
      }
    }
  }
    ...
    while (true)
    {
      ...
      uu____8 =
        core_iter_range___core__iter__traits__iterator__Iterator_for_core__ops__range__Range_A___3__next(&iter,
          size_t,
          core_option_Option__size_t);
      if (uu____8.tag == core_option_None)
      {
        break;
      }
      else
      {
        size_t j = uu____8.f0;
        memcpy(a_matrix[i0][j], a_transpose[j][i0], (size_t)256U * sizeof (int32_t));
      }
    }
  }
  int32_t uu____9[4U][256U];
  memcpy(uu____9, secret_as_ntt, (size_t)4U * sizeof (int32_t [256U]));
  int32_t uu____10[4U][256U];
  memcpy(uu____10, t_as_ntt, (size_t)4U * sizeof (int32_t [256U]));
  int32_t uu____11[4U][4U][256U];
  memcpy(uu____11, a_matrix, (size_t)4U * sizeof (int32_t [4U][256U]));
  __libcrux_kyber_arithmetic_PolynomialRingElement_4size_t__libcrux_kyber_arithmetic_PolynomialRingElement_4size_t__libcrux_kyber_arithmetic_PolynomialRingElement_4size_t__4size_t_
  uu____12;
  memcpy(uu____12.fst, uu____9, (size_t)4U * sizeof (int32_t [256U]));
  memcpy(uu____12.snd, uu____10, (size_t)4U * sizeof (int32_t [256U]));
  memcpy(uu____12.thd, uu____11, (size_t)4U * sizeof (int32_t [4U][256U]));
  uint8_t uu____13[1568U];
  memcpy(uu____13, public_key_serialized, (size_t)1568U * sizeof (uint8_t));
  __libcrux_kyber_arithmetic_PolynomialRingElement_4size_t____libcrux_kyber_arithmetic_PolynomialRingElement_4size_t____libcrux_kyber_arithmetic_PolynomialRingElement_4size_t__4size_t__uint8_t_1568size_t_
  lit;
  lit.fst = uu____12;
  memcpy(lit.snd, uu____13, (size_t)1568U * sizeof (uint8_t));
  return lit;
}
...
)
{
    ...
    i++)
  {
    ...
    invert_ntt_montgomery___4size_t(result[i0], uu____2);
    memcpy(result[i0], uu____2, (size_t)256U * sizeof (int32_t));
    core_ops_range_Range__size_t
    iter0 =
      core_iter_traits_collect___core__iter__traits__collect__IntoIterator_for_I___into_iter((
          (core_ops_range_Range__size_t){
    ...
    while (true)
    {
      ...
      else
      {
        ...
        coefficient_normal_form =
          libcrux_kyber_arithmetic_montgomery_reduce(result[i0][j] * (int32_t)1441);
        int32_t
        uu____4 = libcrux_kyber_arithmetic_barrett_reduce(coefficient_normal_form + error_1[i0][j]);
        result[i0][j] = uu____4;
      }
    }
  }
