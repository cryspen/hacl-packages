/*
  ...
  --config ../../kyber-c.yaml ../libcrux_kyber.llbc F* version: a32b316e KaRaMeL
  version: 08bfa78a
 */
...
typedef uint8_t XofState_tags;

typedef struct XofState_s
{
  XofState_tags tag;
  union
  {
    libcrux_digest_Shake128StateX2 case_X2;
    libcrux_digest_Shake128StateX3 case_X3;
    libcrux_digest_Shake128StateX4 case_X4;
  } val;
} XofState;
...
{
  XofState uu____0;
  libcrux_digest_Shake128StateX3 state = libcrux_digest_shake128_init_x3();
  libcrux_digest_Shake128StateX3* uu____1 = &state;
  ...
  uu____0 = ((XofState){ .tag = X3, .val = { .case_X3 = state } });
  return uu____0;
}

typedef struct
  __uint8_t_504size_t__3size_t__libcrux_kyber_hash_functions_XofState_s
{
  uint8_t fst[3U][504U];
  XofState snd;
...
typedef struct
  __uint8_t_168size_t__3size_t__libcrux_kyber_hash_functions_XofState_s
{
  uint8_t fst[3U][168U];
  XofState snd;
} __uint8_t_168size_t__3size_t__libcrux_kyber_hash_functions_XofState;

static __uint8_t_168size_t__3size_t__libcrux_kyber_hash_functions_XofState
...
sample_from_xof___3size_t(uint8_t seeds[3U][34U], int32_t ret[3U][256U])
{
  ...
  XofState xof_state = XOF_absorb___3size_t(uu____0);
  __uint8_t_504size_t__3size_t__libcrux_kyber_hash_functions_XofState uu____1 =
    XOF_squeeze_three_blocks___3size_t(xof_state);
  uint8_t randomness0[3U][504U];
  memcpy(randomness0, uu____1.fst, (size_t)3U * sizeof(uint8_t[504U]));
  XofState new_state0 = uu____1.snd;
  xof_state = new_state0;
  ...
  while (true) {
    ...
    XofState new_state = uu____3.snd;
    xof_state = new_state;
    uint8_t uu____4[3U][168U];
