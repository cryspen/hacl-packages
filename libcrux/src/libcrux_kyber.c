...
{
  int64_t t = core_convert_num__i64_59__from(value) * BARRETT_MULTIPLIER + (BARRETT_R >> 1U);
...
static int32_t montgomery_multiply_fe_by_fer(int32_t fe, int32_t fer)
{
...
)
{
  ...
  while (true)
  {
    ...
    uu____0 =
      core_iter_range__core__ops__range__Range_A__3__next(&iter,
        size_t,
        core_option_Option__size_t);
...
static void serialize_uncompressed_ring_element(int32_t re[256U], uint8_t ret[384U])
{
...
static void sample_from_binomial_distribution_2(Eurydice_slice randomness, int32_t ret[256U])
{
  ...
  while (true)
  {
    core_option_Option__size_t
    uu____0 =
      core_iter_range__core__ops__range__Range_A__3__next(&iter0,
        size_t,
        core_option_Option__size_t);
    if (uu____0.tag == core_option_None)
    {
...
static void ntt_at_layer(size_t *zeta_i, int32_t re[256U], size_t layer, int32_t ret[256U])
{
...
static void ntt_at_layer_3(size_t *zeta_i, int32_t re[256U], size_t layer, int32_t ret[256U])
{
  int32_t ret0[256U];
...
static void ntt_binomially_sampled_ring_element(int32_t re[256U], int32_t ret[256U])
{
...
static void rejection_sampling_panic_with_diagnostic(void)
{
  KRML_HOST_EPRINTF("KaRaMeL abort at %s:%d\n%s\n", __FILE__, __LINE__, "panic!");
  KRML_HOST_EXIT(255U);
}

static void sample_from_uniform_distribution(uint8_t randomness[840U], int32_t ret[256U])
{
        ...
        if (d1 < FIELD_MODULUS)
        {
          if (sampled_coefficients < COEFFICIENTS_IN_RING_ELEMENT)
          {
            ...
            if (d2 < FIELD_MODULUS)
            {
              ...
              else if (sampled_coefficients == COEFFICIENTS_IN_RING_ELEMENT)
              {
                done = true;
              }
            }
...
static void ntt_multiply(int32_t (*lhs)[256U], int32_t (*rhs)[256U], int32_t ret[256U])
{
  int32_t out[256U];
  memcpy(out, ZERO, (size_t)256U * sizeof (int32_t));
  core_ops_range_Range__size_t
...
static void deserialize_then_decompress_message(uint8_t serialized[32U], int32_t ret[256U])
{
  int32_t re[256U];
  memcpy(re, ZERO, (size_t)256U * sizeof (int32_t));
  core_ops_range_Range__size_t lit;
...
static void deserialize_then_decompress_10(Eurydice_slice serialized, int32_t ret[256U])
{
  int32_t re[256U];
  memcpy(re, ZERO, (size_t)256U * sizeof (int32_t));
  core_ops_range_Range__size_t
...
static void deserialize_then_decompress_11(Eurydice_slice serialized, int32_t ret[256U])
{
  int32_t re[256U];
  memcpy(re, ZERO, (size_t)256U * sizeof (int32_t));
  core_ops_range_Range__size_t
...
static __int32_t_int32_t decompress_coefficients_4(uint8_t *byte)
{
...
static void deserialize_then_decompress_4(Eurydice_slice serialized, int32_t ret[256U])
{
  int32_t re[256U];
  memcpy(re, ZERO, (size_t)256U * sizeof (int32_t));
  core_ops_range_Range__size_t
...
static void deserialize_then_decompress_5(Eurydice_slice serialized, int32_t ret[256U])
{
  int32_t re[256U];
  memcpy(re, ZERO, (size_t)256U * sizeof (int32_t));
  core_ops_range_Range__size_t
...
static void compress_then_serialize_message(int32_t re[256U], uint8_t ret[32U])
{
...
static void deserialize_public_key___3size_t(Eurydice_slice public_key, int32_t ret[3U][256U])
{
...
{
  int32_t pk[3U][256U];
  deserialize_public_key___3size_t(Eurydice_array_to_slice((size_t)1184U,
      public_key,
      uint8_t,
      Eurydice_slice),
    pk);
  ...
  serialize_public_key___3size_t_1152size_t_1184size_t(uu____0,
    ...
    public_key_serialized);
  return
    core_array_equality___Array_A__N___eq((size_t)1184U,
      public_key,
      public_key_serialized,
      uint8_t,
      uint8_t,
...
static void XOFx4___3size_t(uint8_t input[3U][34U], uint8_t ret[3U][840U])
{
  uint8_t out[3U][840U] = { 0U };
  bool uu____0;
  ...
  else
  {
    ...
    Eurydice_slice
    uu____4 = Eurydice_array_to_slice((size_t)34U, input[1U], uint8_t, Eurydice_slice);
    Eurydice_slice
    uu____5 = Eurydice_array_to_slice((size_t)34U, input[2U], uint8_t, Eurydice_slice);
  ...
  while (true)
  {
    ...
    else
    {
      ...
      while (true)
      {
        core_option_Option__size_t
        uu____2 =
          core_iter_range__core__ops__range__Range_A__3__next(&iter1,
            size_t,
            core_option_Option__size_t);
      ...
      XOFx4___3size_t(uu____3, xof_bytes);
      core_ops_range_Range__size_t
      iter =
        core_iter_traits_collect__I__into_iter((
            (core_ops_range_Range__size_t){ .start = (size_t)0U, .end = (size_t)3U }
      ...
      while (true)
      {
        ...
        else
        {
          ...
          int32_t sampled[256U];
          sample_from_uniform_distribution(uu____5, sampled);
          if (transpose)
          {
...
static void into_padded_array___34size_t(Eurydice_slice slice, uint8_t ret[34U])
{
  uint8_t out[34U] = { 0U };
  uint8_t *uu____0 = out;
...
static void into_padded_array___33size_t(Eurydice_slice slice, uint8_t ret[33U])
{
  uint8_t out[33U] = { 0U };
  uint8_t *uu____0 = out;
...
)
{
  ...
  core_ops_range_Range__size_t
  iter =
    core_iter_traits_collect__I__into_iter(lit0,
      core_ops_range_Range__size_t,
      core_ops_range_Range__size_t);
  while (true)
  {
...
static void into_padded_array___64size_t(Eurydice_slice slice, uint8_t ret[64U])
{
  uint8_t out[64U] = { 0U };
  uint8_t *uu____0 = out;
...
static void invert_ntt_montgomery___3size_t(int32_t re[256U], int32_t ret[256U])
{
...
static void compress_then_serialize_10___320size_t(int32_t re[256U], uint8_t ret[320U])
{
...
static void compress_then_serialize_11___320size_t(int32_t re[256U], uint8_t ret[320U])
{
  uint8_t serialized[320U] = { 0U };
  core_ops_range_Range__size_t lit;
  lit.start = (size_t)0U;
...
static void compress_then_serialize_4___128size_t(int32_t re[256U], uint8_t ret[128U])
{
...
static void compress_then_serialize_5___128size_t(int32_t re[256U], uint8_t ret[128U])
{
  uint8_t serialized[128U] = { 0U };
  core_ops_range_Range__size_t lit;
  lit.start = (size_t)0U;
...
static void into_padded_array___1088size_t(Eurydice_slice slice, uint8_t ret[1088U])
{
...
{
  int32_t t_as_ntt[3U][256U];
  deserialize_public_key___3size_t(public_key, t_as_ntt);
  Eurydice_slice
...
static void ntt_vector_u___10size_t(int32_t re[256U], int32_t ret[256U])
{
...
static void deserialize_secret_key___3size_t(Eurydice_slice secret_key, int32_t ret[3U][256U])
{
  int32_t secret_as_ntt[3U][256U];
  for (size_t i = (size_t)0U; i < (size_t)3U; i++)
  {
...
static void into_padded_array___1120size_t(Eurydice_slice slice, uint8_t ret[1120U])
{
