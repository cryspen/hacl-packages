...
static void
from___1184size_t(uint8_t value[1184U], uint8_t ret[1184U])
{
  ...
  uint8_t ret[1088U])
{
  ...
  uint8_t ret1[1088U];
  encrypt_unpacked___3size_t_1088size_t_1152size_t_960size_t_128size_t_10size_t_4size_t_320size_t_2size_t_128size_t_2size_t_128size_t(
    uu____0, uu____1, uu____2, randomness, ret1);
  ...
  uint8_t ret[32U])
{
  ...
  uint8_t to_hash[1120U];
  into_padded_array___1120size_t(implicit_rejection_value, to_hash);
  Eurydice_slice uu____1 = Eurydice_array_to_subslice_from((size_t)1120U,
                                                           to_hash,
                                                           SHARED_SECRET_SIZE,
                                                           uint8_t,
                                                           size_t,
                                                           Eurydice_slice);
  core_slice___Slice_T___copy_from_slice(
    uu____1, as_ref___1088size_t(ciphertext), uint8_t, void*);
  uint8_t implicit_rejection_shared_secret[32U];
  PRF___32size_t(
    Eurydice_array_to_slice((size_t)1120U, to_hash, uint8_t, Eurydice_slice),
    implicit_rejection_shared_secret);
  ...
  uint8_t expected_ciphertext[1088U];
  encrypt_unpacked___3size_t_1088size_t_1152size_t_960size_t_128size_t_10size_t_4size_t_320size_t_2size_t_128size_t_2size_t_128size_t(
    uu____2, uu____3, uu____4, pseudorandomness, expected_ciphertext);
