  ...
  uint8_t* public_key)
{
  ...
  libcrux_kyber_ind_cpa_deserialize_public_key___3size_t(
    ...
    pk);
  Eurydice_slice seed_for_a = Eurydice_array_to_subslice_from(
    (size_t)1184U, public_key, (size_t)1152U, uint8_t, size_t, Eurydice_slice);
  int32_t uu____0[3U][256U];
  memcpy(uu____0, pk, (size_t)3U * sizeof(int32_t[256U]));
  uint8_t public_key_serialized[1184U];
  libcrux_kyber_ind_cpa_serialize_public_key___3size_t_1152size_t_1184size_t(
    uu____0, seed_for_a, public_key_serialized);
...
libcrux_kyber_kyber768_validate_public_key(uint8_t public_key[1184U])
{
  ...
  if (libcrux_kyber_validate_public_key___3size_t_1152size_t_1184size_t(
        public_key)) {
  ...
  uint8_t randomness[64U])
{
  ...
  return libcrux_kyber_types__libcrux_kyber__types__MlKemKeyPair_PRIVATE_KEY_SIZE__PUBLIC_KEY_SIZE___from___2400size_t_1184size_t(
    uu____3, uu____4);
}
