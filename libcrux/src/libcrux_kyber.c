...
static void
rejection_sampling_panic_with_diagnostic(void)
{
  KRML_HOST_EPRINTF(
...
static void
sample_from_uniform_distribution(uint8_t randomness[840U], int32_t ret[256U])
{
...
static void
XOFx4___3size_t(uint8_t input[3U][34U], uint8_t ret[3U][840U])
{
