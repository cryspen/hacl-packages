...
static int32_t montgomery_reduce(int32_t value)
{
  uint32_t
  t =
    get_n_least_significant_bits(MONTGOMERY_SHIFT,
      (uint32_t)value)
...
static inline int32_t montgomery_multiply_fe_by_fer(int32_t fe, int32_t fer)
{
...
static inline int32_t to_standard_domain(int32_t mfe)
{
  return montgomery_reduce(mfe * MONTGOMERY_R_SQUARED_MOD_FIELD_MODULUS);
}

static inline uint16_t to_unsigned_representative(int32_t fe)
{
...
static int32_t compress_ciphertext_coefficient(uint8_t coefficient_bits, uint16_t fe)
{
  ...
  return (int32_t)get_n_least_significant_bits(coefficient_bits, (uint32_t)compressed);
}

static inline int32_t decompress_message_coefficient(int32_t fe)
{
...
)
{
  ...
  iter =
    core_iter_traits_collect___core__iter__traits__collect__IntoIterator_for_I___into_iter((
        (core_ops_range_Range__size_t){ .start = (size_t)0U, .end = SHARED_SECRET_SIZE }
      ),
      core_ops_range_Range__size_t,
      core_ops_range_Range__size_t);
  while (true)
  {
    ...
    {
      size_t i = uu____0.f0;
      uint8_t uu____1 = (uint32_t)Eurydice_slice_index(lhs, i, uint8_t, uint8_t) & (uint32_t)mask;
...
static void G(Eurydice_slice input, uint8_t ret[64U])
{
  uint8_t ret0[64U];
...
static void H(Eurydice_slice input, uint8_t ret[32U])
{
  uint8_t ret0[32U];
...
static inline void free_state(libcrux_digest_incremental_x4_Shake128StateX4 xof_state)
{
...
static inline __uint8_t_uint8_t_uint8_t
compress_coefficients_3(uint16_t coefficient1, uint16_t coefficient2)
{
  ...
  return ((__uint8_t_uint8_t_uint8_t){ .fst = coef1, .snd = coef2, .thd = coef3 });
}

static inline void serialize_uncompressed_ring_element(int32_t re[256U], uint8_t ret[384U])
{
  ...
  while (true)
  {
    ...
    else
    {
      ...
      uint16_t
      coefficient1 =
        to_unsigned_representative(Eurydice_slice_index(coefficients, (size_t)0U, int32_t, int32_t));
      uint16_t
      coefficient2 =
        to_unsigned_representative(Eurydice_slice_index(coefficients, (size_t)1U, int32_t, int32_t));
      __uint8_t_uint8_t_uint8_t uu____1 = compress_coefficients_3(coefficient1, coefficient2);
...
static void sample_from_binomial_distribution_2(Eurydice_slice randomness, int32_t ret[256U])
{
  ...
  iter0 =
    core_iter_traits_collect___core__iter__traits__collect__IntoIterator_for_I___into_iter((
        (core_ops_range_Range__size_t){
          .start = (size_t)0U,
          .end = core_slice___Slice_T___len(randomness, uint8_t, size_t) / (size_t)4U
        }
      ),
      core_ops_range_Range__size_t,
      core_ops_range_Range__size_t);
...
static void sample_from_binomial_distribution_3(Eurydice_slice randomness, int32_t ret[256U])
{
  int32_t sampled[256U];
  memcpy(sampled, ZERO, (size_t)256U * sizeof (int32_t));
  core_ops_range_Range__size_t
  iter0 =
    core_iter_traits_collect___core__iter__traits__collect__IntoIterator_for_I___into_iter((
        (core_ops_range_Range__size_t){
          .start = (size_t)0U,
          .end = core_slice___Slice_T___len(randomness, uint8_t, size_t) / (size_t)3U
        }
      ),
      core_ops_range_Range__size_t,
      core_ops_range_Range__size_t);
    ...
    else
    {
      ...
      while (true)
      {
        ...
        else
        {
          size_t j = uu____1.f0;
          int32_t
          t = montgomery_multiply_fe_by_fer(re[j + step], ZETAS_TIMES_MONTGOMERY_R[zeta_i[0U]]);
          re[j + step] = re[j] - t;
          re[j] = re[j] + t;
        }
      }
...
static inline void
ntt_at_layer_3(size_t *zeta_i, int32_t re[256U], size_t layer, int32_t ret[256U])
{
  int32_t ret0[256U];
...
static inline void ntt_binomially_sampled_ring_element(int32_t re[256U], int32_t ret[256U])
{
  ...
  iter0 =
    core_iter_traits_collect___core__iter__traits__collect__IntoIterator_for_I___into_iter((
        (core_ops_range_Range__size_t){ .start = (size_t)0U, .end = COEFFICIENTS_IN_RING_ELEMENT }
      ),
      core_ops_range_Range__size_t,
      core_ops_range_Range__size_t);
  while (true)
...
static inline __int32_t_int32_t
ntt_multiply_binomials(__int32_t_int32_t _, __int32_t_int32_t _0, int32_t zeta)
{
  ...
  int32_t uu____1 = montgomery_reduce(uu____0 + montgomery_reduce(a1 * b1) * zeta);
  return ((__int32_t_int32_t){ .fst = uu____1, .snd = montgomery_reduce(a0 * b1 + a1 * b0) });
}

static inline void ntt_multiply(int32_t (*lhs)[256U], int32_t (*rhs)[256U], int32_t ret[256U])
{
  int32_t out[256U];
  ...
  iter =
    core_iter_traits_collect___core__iter__traits__collect__IntoIterator_for_I___into_iter((
        (core_ops_range_Range__size_t){
          .start = (size_t)0U,
          .end = COEFFICIENTS_IN_RING_ELEMENT / (size_t)4U
        }
      ),
      core_ops_range_Range__size_t,
      core_ops_range_Range__size_t);
  while (true)
  {
    ...
    else
    {
      ...
      __int32_t_int32_t
      product = ntt_multiply_binomials(lit0, lit1, ZETAS_TIMES_MONTGOMERY_R[(size_t)64U + i]);
      ...
      __int32_t_int32_t
      product0 = ntt_multiply_binomials(lit2, lit, -ZETAS_TIMES_MONTGOMERY_R[(size_t)64U + i]);
...
static inline __uint8_t_uint8_t_uint8_t_uint8_t_uint8_t
...
static inline __uint8_t_uint8_t_uint8_t_uint8_t_uint8_t_uint8_t_uint8_t_uint8_t_uint8_t_uint8_t_uint8_t
...
static inline void
invert_ntt_at_layer(size_t *zeta_i, int32_t re[256U], size_t layer, int32_t ret[256U])
{
  size_t step = (size_t)1U << (uint32_t)layer;
  core_ops_range_Range__size_t
  iter =
    ...
    else
    {
      ...
      while (true)
      {
        ...
        else
        {
          ...
          re[j] = re[j] + re[j + step];
          int32_t uu____2 = montgomery_reduce(a_minus_b * ZETAS_TIMES_MONTGOMERY_R[zeta_i[0U]]);
          re[j + step] = uu____2;
        }
      }
    }
    ...
    else
    {
      ...
      while (true)
      {
        ...
        else
        {
          ...
          int32_t uu____2 = decompress_message_coefficient(coefficient_compressed);
...
static inline void
deserialize_to_reduced_ring_element(Eurydice_slice ring_element, int32_t ret[256U])
{
  int32_t re[256U];
  memcpy(re, ZERO, (size_t)256U * sizeof (int32_t));
  core_ops_range_Range__size_t
  iter =
    core_iter_traits_collect___core__iter__traits__collect__IntoIterator_for_I___into_iter((
        (core_ops_range_Range__size_t){
          .start = (size_t)0U,
          .end = core_slice___Slice_T___len(ring_element, uint8_t, size_t) / (size_t)3U
        }
      ),
      core_ops_range_Range__size_t,
      core_ops_range_Range__size_t);
...
static inline __int32_t_int32_t_int32_t_int32_t
decompress_coefficients_10(
  int32_t byte2,
  int32_t byte1,
  int32_t byte3,
  int32_t byte4,
...
static inline void deserialize_then_decompress_10(Eurydice_slice serialized, int32_t ret[256U])
{
  int32_t re[256U];
  memcpy(re, ZERO, (size_t)256U * sizeof (int32_t));
  core_ops_range_Range__size_t
  iter =
    core_iter_traits_collect___core__iter__traits__collect__IntoIterator_for_I___into_iter((
        (core_ops_range_Range__size_t){
          .start = (size_t)0U,
          .end = core_slice___Slice_T___len(serialized, uint8_t, size_t) / (size_t)5U
        }
      ),
      core_ops_range_Range__size_t,
      core_ops_range_Range__size_t);
  while (true)
  {
    ...
    else
    {
      ...
      __int32_t_int32_t_int32_t_int32_t
      uu____1 = decompress_coefficients_10(byte2, byte1, byte3, byte4, byte5);
...
typedef struct __int32_t_int32_t_int32_t_int32_t_int32_t_int32_t_int32_t_int32_t_s
{
  int32_t fst;
  int32_t snd;
  int32_t thd;
...
static inline __int32_t_int32_t_int32_t_int32_t_int32_t_int32_t_int32_t_int32_t
...
static inline void deserialize_then_decompress_11(Eurydice_slice serialized, int32_t ret[256U])
{
  int32_t re[256U];
  memcpy(re, ZERO, (size_t)256U * sizeof (int32_t));
  core_ops_range_Range__size_t
  iter =
    core_iter_traits_collect___core__iter__traits__collect__IntoIterator_for_I___into_iter((
        (core_ops_range_Range__size_t){
          .start = (size_t)0U,
          .end = core_slice___Slice_T___len(serialized, uint8_t, size_t) / (size_t)11U
        }
      ),
      core_ops_range_Range__size_t,
      core_ops_range_Range__size_t);
  while (true)
  {
    ...
    else
    {
      ...
      __int32_t_int32_t_int32_t_int32_t_int32_t_int32_t_int32_t_int32_t
      uu____1 =
        decompress_coefficients_11(byte2,
          byte1,
          byte3,
          byte5,
          byte4,
...
static inline void
ntt_at_layer_3328(size_t *zeta_i, int32_t re[256U], size_t layer, int32_t ret[256U])
{
  int32_t ret0[256U];
  ntt_at_layer(zeta_i, re, layer, ret0);
  memcpy(ret, ret0, (size_t)256U * sizeof (int32_t));
...
static inline void
deserialize_to_uncompressed_ring_element(Eurydice_slice serialized, int32_t ret[256U])
{
  int32_t re[256U];
  memcpy(re, ZERO, (size_t)256U * sizeof (int32_t));
  core_ops_range_Range__size_t
  iter =
    core_iter_traits_collect___core__iter__traits__collect__IntoIterator_for_I___into_iter((
        (core_ops_range_Range__size_t){
          .start = (size_t)0U,
          .end = core_slice___Slice_T___len(serialized, uint8_t, size_t) / (size_t)3U
        }
      ),
      core_ops_range_Range__size_t,
      core_ops_range_Range__size_t);
...
static inline __int32_t_int32_t decompress_coefficients_4(uint8_t *byte)
{
...
static inline void deserialize_then_decompress_4(Eurydice_slice serialized, int32_t ret[256U])
{
  int32_t re[256U];
  memcpy(re, ZERO, (size_t)256U * sizeof (int32_t));
  core_ops_range_Range__size_t
...
static inline void deserialize_then_decompress_5(Eurydice_slice serialized, int32_t ret[256U])
{
  int32_t re[256U];
  memcpy(re, ZERO, (size_t)256U * sizeof (int32_t));
  core_ops_range_Range__size_t
...
static inline void compress_then_serialize_message(int32_t re[256U], uint8_t ret[32U])
{
    ...
    else
    {
      ...
      while (true)
      {
        ...
        else
        {
          ...
          uint8_t coefficient_compressed = compress_message_coefficient(coefficient0);
          size_t uu____2 = i;
          serialized[uu____2] =
...
)
{
  ...
  iter =
    core_iter_traits_collect___core__iter__traits__collect__IntoIterator_for_I___into_iter((
        (core_ops_range_Range__size_t){
          .start = (size_t)0U,
          .end = core_slice___Slice_T___len(public_key, uint8_t, size_t) / BYTES_PER_RING_ELEMENT
        }
      ),
      core_ops_range_Range__size_t,
      core_ops_range_Range__size_t);
    ...
    else
    {
      ...
      ring_element =
        Eurydice_slice_subslice(public_key,
          (
            (core_ops_range_Range__size_t){
              .start = i * BYTES_PER_RING_ELEMENT,
              .end = i * BYTES_PER_RING_ELEMENT + BYTES_PER_RING_ELEMENT
            }
          ),
          uint8_t,
          core_ops_range_Range__size_t,
      ...
      uu____1 =
        Eurydice_array_to_subslice((size_t)768U,
          ...
          (
            (core_ops_range_Range__size_t){
              .start = i * BYTES_PER_RING_ELEMENT,
              .end = (i + (size_t)1U) * BYTES_PER_RING_ELEMENT
            }
          ),
          uint8_t,
          core_ops_range_Range__size_t,
...
sample_matrix_A___2size_t(uint8_t seed[34U], bool transpose, int32_t ret[2U][2U][256U])
{
  ...
  while (true)
  {
    ...
    else
    {
      ...
      sample_from_xof___2size_t(uu____3, sampled);
      core_ops_range_Range__size_t
      iter =
        core_iter_traits_collect___core__iter__traits__collect__IntoIterator_for_I___into_iter((
            (core_ops_range_Range__size_t){ .start = (size_t)0U, .end = (size_t)2U }
...
static inline void into_padded_array___34size_t(Eurydice_slice slice, uint8_t ret[34U])
{
  uint8_t out[34U] = { 0U };
  uint8_t *uu____0 = out;
...
static inline void into_padded_array___33size_t(Eurydice_slice slice, uint8_t ret[33U])
{
  uint8_t out[33U] = { 0U };
  uint8_t *uu____0 = out;
...
sample_from_binomial_distribution___3size_t(Eurydice_slice randomness, int32_t ret[256U])
{
  ...
  sample_from_binomial_distribution_3(randomness, uu____0);
    ...
    else
    {
      ...
      while (true)
      {
        ...
        else
        {
          ...
          add_to_ring_element___2size_t(result[i], &product, uu____2);
      ...
      while (true)
      {
        ...
        else
        {
          ...
          int32_t uu____4 = barrett_reduce(coefficient_normal_form + error_as_ntt[i][j]);
          result[i][j] = uu____4;
        }
      }
    }
...
)
{
  ...
  int32_t uu____11[2U][256U];
  memcpy(uu____11, secret_as_ntt, (size_t)2U * sizeof (int32_t [256U]));
  int32_t uu____12[2U][256U];
  memcpy(uu____12, t_as_ntt, (size_t)2U * sizeof (int32_t [256U]));
  int32_t uu____13[2U][2U][256U];
  memcpy(uu____13, a_matrix, (size_t)2U * sizeof (int32_t [2U][256U]));
  __libcrux_kyber_arithmetic_PolynomialRingElement_2size_t__libcrux_kyber_arithmetic_PolynomialRingElement_2size_t__libcrux_kyber_arithmetic_PolynomialRingElement_2size_t__2size_t_
  uu____14;
  memcpy(uu____14.fst, uu____11, (size_t)2U * sizeof (int32_t [256U]));
  memcpy(uu____14.snd, uu____12, (size_t)2U * sizeof (int32_t [256U]));
  memcpy(uu____14.thd, uu____13, (size_t)2U * sizeof (int32_t [2U][256U]));
  uint8_t uu____15[800U];
  memcpy(uu____15, public_key_serialized, (size_t)800U * sizeof (uint8_t));
  __libcrux_kyber_arithmetic_PolynomialRingElement_2size_t____libcrux_kyber_arithmetic_PolynomialRingElement_2size_t____libcrux_kyber_arithmetic_PolynomialRingElement_2size_t__2size_t__uint8_t_800size_t_
  lit;
  lit.fst = uu____14;
  memcpy(lit.snd, uu____15, (size_t)800U * sizeof (uint8_t));
  return lit;
}
...
)
{
  ...
  uu____6 =
    Eurydice_array_to_subslice((size_t)1632U,
      out,
      ((core_ops_range_Range__size_t){ .start = pointer, .end = pointer + H_DIGEST_SIZE }),
      uint8_t,
      core_ops_range_Range__size_t,
      Eurydice_slice);
  uint8_t ret0[32U];
...
)
{
  ...
  H(Eurydice_array_to_slice((size_t)800U, ind_cpa_public_key, uint8_t, Eurydice_slice),
...
static inline void into_padded_array___64size_t(Eurydice_slice slice, uint8_t ret[64U])
{
  uint8_t out[64U] = { 0U };
  uint8_t *uu____0 = out;
...
static void PRF___128size_t(Eurydice_slice input, uint8_t ret[128U])
{
  uint8_t ret0[128U];
...
static inline void
sample_from_binomial_distribution___2size_t(Eurydice_slice randomness, int32_t ret[256U])
{
  int32_t uu____0[256U];
...
)
{
  ...
  while (true)
  {
    ...
    else
    {
      ...
      PRF___128size_t(Eurydice_array_to_slice((size_t)33U, prf_input, uint8_t, Eurydice_slice),
        prf_output);
      int32_t uu____1[256U];
      sample_from_binomial_distribution___2size_t(Eurydice_array_to_slice((size_t)128U,
          prf_output,
          uint8_t,
          Eurydice_slice),
        uu____1);
...
)
{
  ...
  while (true)
  {
    ...
    else
    {
      ...
      invert_ntt_montgomery___2size_t(result[i], uu____3);
      ...
      while (true)
      {
        ...
        {
          size_t j = uu____4.f0;
          int32_t coefficient_normal_form = montgomery_reduce(result[i][j] * (int32_t)1441);
          int32_t uu____5 = barrett_reduce(coefficient_normal_form + error_1[i][j]);
          result[i][j] = uu____5;
        }
      }
    }
...
)
{
  ...
  while (true)
  {
    ...
    {
      size_t i = uu____1.f0;
      int32_t coefficient_normal_form = montgomery_reduce(result[i] * (int32_t)1441);
      int32_t uu____2 = barrett_reduce(coefficient_normal_form + error_2[0U][i] + message[0U][i]);
      result[i] = uu____2;
    }
  }
    ...
    else
    {
      ...
      coefficient1 =
        compress_ciphertext_coefficient(10U,
          to_unsigned_representative(Eurydice_slice_index(coefficients,
              (size_t)0U,
              int32_t,
              int32_t)));
      int32_t
      ...
      coefficient4 =
        compress_ciphertext_coefficient(10U,
          to_unsigned_representative(Eurydice_slice_index(coefficients,
              ...
              int32_t)));
      __uint8_t_uint8_t_uint8_t_uint8_t_uint8_t
      uu____1 = compress_coefficients_10(coefficient1, coefficient2, coefficient3, coefficient4);
      uint8_t coef1 = uu____1.fst;
      uint8_t coef2 = uu____1.snd;
      uint8_t coef3 = uu____1.thd;
...
static inline void compress_then_serialize_11___320size_t(int32_t re[256U], uint8_t ret[320U])
{
  ...
  while (true)
  {
    ...
    else
    {
      ...
      __uint8_t_uint8_t_uint8_t_uint8_t_uint8_t_uint8_t_uint8_t_uint8_t_uint8_t_uint8_t_uint8_t
      uu____1 =
        compress_coefficients_11(coefficient1,
          coefficient2,
          coefficient3,
          coefficient4,
          coefficient5,
...
static inline void
compress_then_serialize_ring_element_u___10size_t_320size_t(
  int32_t re[256U],
  uint8_t ret[320U]
)
{
...
static inline void compress_then_serialize_4___128size_t(int32_t re[256U], uint8_t ret[128U])
{
  ...
  while (true)
  {
    ...
    else
    {
      ...
      uint8_t
      coefficient1 =
        (uint8_t)compress_ciphertext_coefficient(4U,
          to_unsigned_representative(Eurydice_slice_index(coefficients,
              (size_t)0U,
              int32_t,
              int32_t)));
...
static inline void compress_then_serialize_5___128size_t(int32_t re[256U], uint8_t ret[128U])
{
  ...
  while (true)
  {
    ...
    else
    {
      ...
      uint8_t
      coefficient1 =
        (uint8_t)compress_ciphertext_coefficient(5U,
          to_unsigned_representative(Eurydice_slice_index(coefficients,
              (size_t)0U,
              int32_t,
              int32_t)));
...
static inline void
compress_then_serialize_ring_element_v___4size_t_128size_t(int32_t re[256U], uint8_t ret[128U])
{
...
{
  uint8_t to_hash[64U];
  into_padded_array___64size_t(Eurydice_array_to_slice((size_t)32U,
      randomness,
      uint8_t,
      Eurydice_slice),
    to_hash);
  ...
  uu____0 =
    Eurydice_array_to_subslice_from((size_t)64U,
      ...
      Eurydice_slice);
  uint8_t ret[32U];
  H(Eurydice_array_to_slice((size_t)800U,
  ...
  core_slice___Slice_T___copy_from_slice(uu____0,
    ...
    void *);
  uint8_t hashed[64U];
  G(Eurydice_array_to_slice((size_t)64U, to_hash, uint8_t, Eurydice_slice), hashed);
  K___Eurydice_slice_uint8_t_Eurydice_slice_uint8_t
  uu____1 =
    core_slice___Slice_T___split_at(Eurydice_array_to_slice((size_t)64U,
        hashed,
...
deserialize_secret_key___2size_t(Eurydice_slice secret_key, int32_t ret[2U][256U])
{
  ...
  iter =
    core_iter_traits_collect___core__iter__traits__collect__IntoIterator_for_I___into_iter((
        (core_ops_range_Range__size_t){
          .start = (size_t)0U,
          .end = core_slice___Slice_T___len(secret_key, uint8_t, size_t) / BYTES_PER_RING_ELEMENT
        }
      ),
      core_ops_range_Range__size_t,
      core_ops_range_Range__size_t);
...
static inline void
deserialize_then_decompress_ring_element_u___10size_t(
...
static inline void ntt_vector_u___10size_t(int32_t re[256U], int32_t ret[256U])
{
...
)
{
  ...
  iter =
    core_iter_traits_collect___core__iter__traits__collect__IntoIterator_for_I___into_iter((
        (core_ops_range_Range__size_t){
          .start = (size_t)0U,
          .end = core_slice___Slice_T___len(Eurydice_array_to_slice((size_t)768U,
              ciphertext,
              uint8_t,
              Eurydice_slice),
            uint8_t,
    ...
    else
    {
      ...
      u_bytes =
        Eurydice_array_to_subslice((size_t)768U,
          ...
          (
            (core_ops_range_Range__size_t){
              .start = i * (COEFFICIENTS_IN_RING_ELEMENT * (size_t)10U / (size_t)8U),
              .end = i
              * (COEFFICIENTS_IN_RING_ELEMENT * (size_t)10U / (size_t)8U)
              + COEFFICIENTS_IN_RING_ELEMENT * (size_t)10U / (size_t)8U
            }
...
)
{
  ...
  int32_t v[256U];
  deserialize_then_decompress_ring_element_v___4size_t(Eurydice_array_to_subslice_from((size_t)768U,
      ciphertext,
      (size_t)640U,
      uint8_t,
      size_t,
...
static void PRF___32size_t(Eurydice_slice input, uint8_t ret[32U])
{
  uint8_t ret0[32U];
...
)
{
  ...
  core_slice___Slice_T___copy_from_slice(Eurydice_array_to_subslice_from((size_t)64U,
    ...
    void *);
  uint8_t hashed[64U];
  G(Eurydice_array_to_slice((size_t)64U, to_hash0, uint8_t, Eurydice_slice), hashed);
  K___Eurydice_slice_uint8_t_Eurydice_slice_uint8_t
  uu____3 =
    core_slice___Slice_T___split_at(Eurydice_array_to_slice((size_t)64U,
        hashed,
  ...
  PRF___32size_t(Eurydice_array_to_slice((size_t)800U, to_hash, uint8_t, Eurydice_slice),
  ...
  uint8_t ret0[32U];
  select_shared_secret_in_constant_time(uu____8,
...
)
{
  ...
  uint8_t ret0[32U];
  select_shared_secret_in_constant_time(uu____6,
    Eurydice_array_to_slice((size_t)32U, implicit_rejection_shared_secret, uint8_t, Eurydice_slice),
    selector,
    ret0);
  memcpy(ret, ret0, (size_t)32U * sizeof (uint8_t));
...
)
{
  ...
  uint8_t ind_cpa_public_key_hash[32U];
  H(Eurydice_array_to_slice((size_t)1184U, ind_cpa_public_key, uint8_t, Eurydice_slice),
    ind_cpa_public_key_hash);
  uint8_t rej[32U];
  Result__uint8_t_32size_t__core_array_TryFromSliceError dst;
  Eurydice_slice_to_array2(&dst,
...
)
{
  ...
  int32_t v[256U];
  deserialize_then_decompress_ring_element_v___4size_t(Eurydice_array_to_subslice_from((size_t)1088U,
      ciphertext,
      (size_t)960U,
      uint8_t,
      size_t,
...
)
{
  ...
  core_slice___Slice_T___copy_from_slice(uu____4,
    ...
    void *);
  uint8_t implicit_rejection_shared_secret[32U];
  PRF___32size_t(Eurydice_array_to_slice((size_t)1120U, to_hash, uint8_t, Eurydice_slice),
    implicit_rejection_shared_secret);
  Eurydice_slice uu____5 = ind_cpa_public_key;
  uint8_t uu____6[32U];
  memcpy(uu____6, decrypted, (size_t)32U * sizeof (uint8_t));
...
sample_matrix_A___4size_t(uint8_t seed[34U], bool transpose, int32_t ret[4U][4U][256U])
{
  ...
  for (size_t i = (size_t)0U; i < (size_t)4U; i++)
  {
    ...
    memcpy(A_transpose[i][1U], ZERO, (size_t)256U * sizeof (int32_t));
    memcpy(A_transpose[i][2U], ZERO, (size_t)256U * sizeof (int32_t));
    memcpy(A_transpose[i][3U], ZERO, (size_t)256U * sizeof (int32_t));
  }
  core_ops_range_Range__size_t
  iter0 =
    core_iter_traits_collect___core__iter__traits__collect__IntoIterator_for_I___into_iter((
  ...
  while (true)
  {
    ...
    else
    {
      ...
      sample_from_xof___4size_t(uu____3, sampled);
      core_ops_range_Range__size_t
      iter =
        core_iter_traits_collect___core__iter__traits__collect__IntoIterator_for_I___into_iter((
            (core_ops_range_Range__size_t){ .start = (size_t)0U, .end = (size_t)4U }
    ...
    else
    {
      ...
      while (true)
      {
        ...
        else
        {
          ...
          ntt_multiply(matrix_element, &s_as_ntt[j], product);
          int32_t uu____2[256U];
          add_to_ring_element___4size_t(result[i], &product, uu____2);
          memcpy(result[i], uu____2, (size_t)256U * sizeof (int32_t));
        }
      }
      core_ops_range_Range__size_t
...
)
{
  ...
  int32_t uu____11[4U][256U];
  memcpy(uu____11, secret_as_ntt, (size_t)4U * sizeof (int32_t [256U]));
  int32_t uu____12[4U][256U];
  memcpy(uu____12, t_as_ntt, (size_t)4U * sizeof (int32_t [256U]));
  int32_t uu____13[4U][4U][256U];
  memcpy(uu____13, a_matrix, (size_t)4U * sizeof (int32_t [4U][256U]));
  __libcrux_kyber_arithmetic_PolynomialRingElement_4size_t__libcrux_kyber_arithmetic_PolynomialRingElement_4size_t__libcrux_kyber_arithmetic_PolynomialRingElement_4size_t__4size_t_
  uu____14;
  memcpy(uu____14.fst, uu____11, (size_t)4U * sizeof (int32_t [256U]));
  memcpy(uu____14.snd, uu____12, (size_t)4U * sizeof (int32_t [256U]));
  memcpy(uu____14.thd, uu____13, (size_t)4U * sizeof (int32_t [4U][256U]));
  uint8_t uu____15[1568U];
  memcpy(uu____15, public_key_serialized, (size_t)1568U * sizeof (uint8_t));
  __libcrux_kyber_arithmetic_PolynomialRingElement_4size_t____libcrux_kyber_arithmetic_PolynomialRingElement_4size_t____libcrux_kyber_arithmetic_PolynomialRingElement_4size_t__4size_t__uint8_t_1568size_t_
  lit;
  lit.fst = uu____14;
  memcpy(lit.snd, uu____15, (size_t)1568U * sizeof (uint8_t));
  return lit;
}
...
)
{
  ...
  uint8_t ind_cpa_public_key_hash[32U];
  H(Eurydice_array_to_slice((size_t)1568U, ind_cpa_public_key, uint8_t, Eurydice_slice),
    ind_cpa_public_key_hash);
  uint8_t rej[32U];
  Result__uint8_t_32size_t__core_array_TryFromSliceError dst;
  Eurydice_slice_to_array2(&dst,
...
)
{
  ...
  while (true)
  {
    ...
    else
    {
      ...
      int32_t uu____3[256U];
      invert_ntt_montgomery___4size_t(result[i], uu____3);
      memcpy(result[i], uu____3, (size_t)256U * sizeof (int32_t));
      core_ops_range_Range__size_t
      iter1 =
        core_iter_traits_collect___core__iter__traits__collect__IntoIterator_for_I___into_iter((
...
)
{
  ...
  uu____0 =
    Eurydice_array_to_subslice_from((size_t)64U,
      ...
      Eurydice_slice);
  uint8_t ret[32U];
  H(Eurydice_array_to_slice((size_t)1568U,
...
{
  int32_t uu____0[256U];
  deserialize_then_decompress_11(serialized, uu____0);
  memcpy(ret, uu____0, (size_t)256U * sizeof (int32_t));
}
...
)
{
  ...
  iter =
    core_iter_traits_collect___core__iter__traits__collect__IntoIterator_for_I___into_iter((
        (core_ops_range_Range__size_t){
          .start = (size_t)0U,
          .end = core_slice___Slice_T___len(Eurydice_array_to_slice((size_t)1568U,
              ciphertext,
              uint8_t,
              Eurydice_slice),
            uint8_t,
            size_t)
          / (COEFFICIENTS_IN_RING_ELEMENT * (size_t)11U / (size_t)8U)
        }
      ),
      core_ops_range_Range__size_t,
      core_ops_range_Range__size_t);
    ...
    else
    {
      ...
      u_bytes =
        Eurydice_array_to_subslice((size_t)1568U,
          ...
          (
            (core_ops_range_Range__size_t){
              .start = i * (COEFFICIENTS_IN_RING_ELEMENT * (size_t)11U / (size_t)8U),
              .end = i
              * (COEFFICIENTS_IN_RING_ELEMENT * (size_t)11U / (size_t)8U)
              + COEFFICIENTS_IN_RING_ELEMENT * (size_t)11U / (size_t)8U
            }
      ...
      int32_t uu____1[256U];
      ntt_vector_u___11size_t(u, uu____1);
      memcpy(u_as_ntt[i], uu____1, (size_t)256U * sizeof (int32_t));
    }
  }
...
{
  int32_t uu____0[256U];
  deserialize_then_decompress_5(serialized, uu____0);
  memcpy(ret, uu____0, (size_t)256U * sizeof (int32_t));
}
...
)
{
  ...
  core_slice___Slice_T___copy_from_slice(uu____4,
    ...
    void *);
  uint8_t implicit_rejection_shared_secret[32U];
  PRF___32size_t(Eurydice_array_to_slice((size_t)1600U, to_hash, uint8_t, Eurydice_slice),
    implicit_rejection_shared_secret);
  Eurydice_slice uu____5 = ind_cpa_public_key;
  uint8_t uu____6[32U];
  memcpy(uu____6, decrypted, (size_t)32U * sizeof (uint8_t));
