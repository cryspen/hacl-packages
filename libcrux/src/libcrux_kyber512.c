...
sample_matrix_A___2size_t(uint8_t seed[34U], bool transpose, int32_t ret[2U][2U][256U])
{
  ...
  for (size_t i0 = (size_t)0U; i0 < (size_t)2U; i0++)
  {
    ...
    uint8_t uu____2[2U][34U];
    memcpy(uu____2, seeds, (size_t)2U * sizeof (uint8_t [34U]));
    int32_t sampled[2U][256U];
    sample_from_xof___2size_t(uu____2, sampled);
    core_ops_range_Range__size_t
    iter =
      core_iter_traits_collect___core__iter__traits__collect__IntoIterator_for_I___into_iter((
          (core_ops_range_Range__size_t){ .start = (size_t)0U, .end = (size_t)2U }
    ...
    i++)
  {
    ...
    while (true)
    {
      ...
      else
      {
        ...
        add_to_ring_element___2size_t(result[i0], &product, uu____1);
...
)
{
  ...
  int32_t uu____10[2U][256U];
  memcpy(uu____10, t_as_ntt, (size_t)2U * sizeof (int32_t [256U]));
  int32_t uu____11[2U][2U][256U];
  memcpy(uu____11, a_matrix, (size_t)2U * sizeof (int32_t [2U][256U]));
  __libcrux_kyber_arithmetic_PolynomialRingElement_2size_t__libcrux_kyber_arithmetic_PolynomialRingElement_2size_t__libcrux_kyber_arithmetic_PolynomialRingElement_2size_t__2size_t_
  uu____12;
  memcpy(uu____12.fst, uu____9, (size_t)2U * sizeof (int32_t [256U]));
  memcpy(uu____12.snd, uu____10, (size_t)2U * sizeof (int32_t [256U]));
  memcpy(uu____12.thd, uu____11, (size_t)2U * sizeof (int32_t [2U][256U]));
  uint8_t uu____13[800U];
  memcpy(uu____13, public_key_serialized, (size_t)800U * sizeof (uint8_t));
  __libcrux_kyber_arithmetic_PolynomialRingElement_2size_t____libcrux_kyber_arithmetic_PolynomialRingElement_2size_t____libcrux_kyber_arithmetic_PolynomialRingElement_2size_t__2size_t__uint8_t_800size_t_
  lit;
  lit.fst = uu____12;
  memcpy(lit.snd, uu____13, (size_t)800U * sizeof (uint8_t));
  return lit;
}
...
)
{
    ...
    i++)
  {
    ...
    invert_ntt_montgomery___2size_t(result[i0], uu____2);
