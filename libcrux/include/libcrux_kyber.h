/*
  ...
  ../libcrux_kyber.llbc F* version: a32b316e KaRaMeL version: 08bfa78a
 */
...
extern core_option_Option__core_cmp_Ordering
...
extern core_option_Option__size_t
...
#define libcrux_digest_shake256(x_0, x_1, x_2, _ret_t)                         \
  libcrux_digest_shake256_(x_0, x_1, x_2)

extern void
libcrux_digest_shake256_(size_t x0, Eurydice_slice x1, uint8_t* x2);

extern bool
libcrux_platform_simd256_support(void);

#define libcrux_digest_shake128(x_0, x_1, x_2, _ret_t)                         \
  libcrux_digest_shake128_(x_0, x_1, x_2)

extern void
libcrux_digest_shake128_(size_t x0, Eurydice_slice x1, uint8_t* x2);
...
extern core_option_Option__uint32_t
...
extern core_option_Option__int32_t
...
extern bool
core_cmp_impls__u8_22__eq(uint8_t* x0, uint8_t* x1);

extern bool
core_cmp_impls__u8_22__ne(uint8_t* x0, uint8_t* x1);
...
bool
libcrux_kyber_validate_public_key___3size_t_1152size_t_1184size_t(
  uint8_t* public_key);
...
typedef uint8_t libcrux_kyber_types_MlKemPrivateKey___2400size_t[2400U];

void
libcrux_kyber_types__libcrux_kyber__types__MlKemPrivateKey_SIZE__8__from___2400size_t(
  uint8_t value[2400U],
  uint8_t ret[2400U]);
...
libcrux_kyber_types_MlKemKeyPair___2400size_t_1184size_t
libcrux_kyber_types__libcrux_kyber__types__MlKemKeyPair_PRIVATE_KEY_SIZE__PUBLIC_KEY_SIZE___from___2400size_t_1184size_t(
  uint8_t sk[2400U],
  uint8_t pk[1184U]);
...
uint8_t*
  libcrux_kyber_types__libcrux_kyber__types__MlKemPublicKey_SIZE__18__as_slice___1184size_t(
    uint8_t (*self)[1184U]);
...
typedef uint8_t libcrux_kyber_types_MlKemCiphertext___1088size_t[1088U];
...
K___Eurydice_slice_uint8_t_Eurydice_slice_uint8_t
  libcrux_kyber_types__libcrux_kyber__types__MlKemPrivateKey_SIZE__12__split_at___2400size_t(
    uint8_t (*self)[2400U],
    size_t mid);
...
Eurydice_slice
  libcrux_kyber_types__libcrux_kyber__types__MlKemCiphertext_SIZE__1__as_ref___1088size_t(
    uint8_t (*self)[1088U]);
