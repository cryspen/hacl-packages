/* 
  ...
  KaRaMeL invocation: /Users/franziskus/repos/eurydice//eurydice --config ../c2.yml ../../libcrux_ml_kem.llbc
  F* version: a32b316e
...
libcrux_intrinsics_arm64__vaddvq_s16(core_core_arch_arm_shared_neon_int16x8_t a){
  return vaddvq_s16(a);
}

static inline uint16_t
libcrux_intrinsics_arm64__vaddv_u16(core_core_arch_arm_shared_neon_uint16x4_t a){
  return vaddv_s16(a);
}

static inline uint16_t
libcrux_intrinsics_arm64__vaddvq_u16(core_core_arch_arm_shared_neon_uint16x8_t a){
  return vaddvq_u16(a);
}
...
#define libcrux_intrinsics_arm64__vshrq_n_u32(N,a)	\
  (vshrq_n_u32(a,N))

#define libcrux_intrinsics_arm64__vshlq_n_u32(N,a) \
  (vshlq_n_u32(a,N))
...
#define libcrux_intrinsics_arm64__vsliq_n_s32(N,a,b) \
  (vsliq_n_s16(a,b,N))

#define libcrux_intrinsics_arm64__vsliq_n_s64(N,a,b) \
  (vsliq_n_s64(a,b,N))
...
libcrux_intrinsics_arm64__vget_low_s16(core_core_arch_arm_shared_neon_int16x8_t a){
