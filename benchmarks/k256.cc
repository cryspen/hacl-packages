...
static void
K256_ECDSA_Sign_Normalized(benchmark::State& state)
{
...
static void
K256_ECDSA_Verify_Normalized(benchmark::State& state)
{
  bytes sk = hex_to_bytes(
    "a32aa1699dcaf84c231dc805981942aa8793b4256d6a21de3e78c9036d39cc1f");
...
static void
K256_ECDSA_Sign(benchmark::State& state)
{
  bytes sk = hex_to_bytes(
    "a32aa1699dcaf84c231dc805981942aa8793b4256d6a21de3e78c9036d39cc1f");
...
static void
K256_ECDSA_Verify(benchmark::State& state)
{
  bytes sk = hex_to_bytes(
    "a32aa1699dcaf84c231dc805981942aa8793b4256d6a21de3e78c9036d39cc1f");
  bytes pk_compressed = hex_to_bytes(
...
static void
K256_ECDH(benchmark::State& state)
{
...
static void
K256_ECDH_NoCompress(benchmark::State& state)
{
  bytes pk_raw = hex_to_bytes(
    "d8096af8a11e0b80037e1ee68246b5dcbb0aeb1cf1244fd767db80f3fa27da2b396812ea"
    "1686e7472e9692eaf3e958e50e9500d3b4c77243db1f2acd67ba9cc4");
...
BENCHMARK(K256_ECDSA_Sign);
BENCHMARK(K256_ECDSA_Sign_Normalized);
BENCHMARK(K256_ECDSA_Verify);
BENCHMARK(K256_ECDSA_Verify_Normalized);
#ifndef NO_OPENSSL
BENCHMARK(Openssl_K256_ECDSA_Sign);
BENCHMARK(Openssl_K256_ECDSA_Verify);
#endif
BENCHMARK(K256_ECDH);
BENCHMARK(K256_ECDH_NoCompress);
#ifndef NO_OPENSSL
