...
impl_hmac!(hmac_sha1, Hacl_HMAC_legacy_compute_sha1, 20);
impl_hmac!(hmac_sha2_256, Hacl_HMAC_compute_sha2_256, 32);
impl_hmac!(hmac_sha2_384, Hacl_HMAC_compute_sha2_384, 48);
impl_hmac!(hmac_sha2_512, Hacl_HMAC_compute_sha2_512, 64);
