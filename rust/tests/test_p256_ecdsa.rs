...
use hacl::digest::Algorithm;
use hacl::p256::{self, Error};
use hacl::signature::{self, Mode as SignatureMode};
...
fn test_wycheproof() {
    let tests: P256TestVector =
        P256TestVector::from_file("tests/wycheproof/ecdsa_secp256r1_sha256_test.json");
